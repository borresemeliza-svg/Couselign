/**
 * Admin Drawer Functionality
 * Shared JavaScript for responsive hamburger menu across all admin pages
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const drawerToggler = document.getElementById('adminNavbarDrawerToggler');
    const drawer = document.getElementById('adminNavbarDrawer');
    const overlay = document.getElementById('adminNavbarOverlay');
    const drawerClose = document.getElementById('adminNavbarDrawerClose');

    if (!drawer || !overlay) {
        return; // Not an admin page with drawer markup
    }
