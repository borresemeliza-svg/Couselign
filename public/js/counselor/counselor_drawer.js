/**
 * Counselor Drawer Functionality
 * Shared JavaScript for responsive hamburger menu across all counselor pages
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const drawerToggler = document.getElementById('counselorNavbarDrawerToggler');
    const drawer = document.getElementById('counselorNavbarDrawer');
    const overlay = document.getElementById('counselorNavbarOverlay');
    const drawerClose = document.getElementById('counselorNavbarDrawerClose');

    if (!drawer || !overlay) {
        return; // Not an counselor page with drawer markup
    }
